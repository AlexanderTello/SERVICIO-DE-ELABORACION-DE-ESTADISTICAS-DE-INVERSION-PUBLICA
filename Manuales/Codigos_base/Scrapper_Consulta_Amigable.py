...
class CONSULTA():# Inicia el scrapper 
    def __init__(self,freq='D'): #Definición de inicio de clase 
        self.browser = webdriver.Chrome(ChromeDriverManager().install()) #Instala la versión más actual de chromium
        if freq == 'D':
            self.browser.get("https://apps5.mineco.gob.pe/transparencia/Navegador/default.aspx") # Consulta diaria
        elif freq == 'M':
            self.browser.get("https://apps5.mineco.gob.pe/transparencia/mensual/") #Consulta mensual
